...
const (
	CodeZNotFound = -1	// 未找到
	firstFile = "/Users/qeeniao35/Desktop/demo2019.xlsx"	// 需要获取收货人姓名和订单号的文件地址
	secondFile = "/Users/qeeniao35/Desktop/expressInfo.xlsx"	// 匹配快递单号的文件地址
	currentFile = "/Users/qeeniao35/Desktop/new-demo.xlsx"	// 读取的文件
...
func main() {
	...
	if newXlsxFileName == "" {
 	...
 	if newError != nil {
 		fmt.Println("\n.\n.\n.\n\n文件(", newXlsxFileName, ")保存失败, 原因:", newError.Error())
 	}else {
 		fmt.Println("\n.\n.\n.\n\n加载完毕，匹配到的数据保存到(", newXlsxFileName, "), 请查收")
 	}
